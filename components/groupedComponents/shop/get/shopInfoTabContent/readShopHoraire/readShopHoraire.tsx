...
const ReadShopHoraire: React.FC<Props> = (props: Props) => {
	const { opening_days, morning_hour_from, morning_hour_to, afternoon_hour_from, afternoon_hour_to } = props;
...
export default ReadShopHoraire;
