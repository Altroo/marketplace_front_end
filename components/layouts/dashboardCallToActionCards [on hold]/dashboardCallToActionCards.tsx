...
import Styles from './dashboardCallToActionCards.module.sass';
...
const DashboardCallToActionCards: React.FC<Props> = (props: Props) => {
	return (
...
export default DashboardCallToActionCards;
